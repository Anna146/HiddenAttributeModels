...
vocab_path = "/home/tigunova/Documents/emb_models/glove.6B.50d_reddit_vocab.txt"
...
syn_dict = eval(open('/home/tigunova/PycharmProjects/ham_rep/data/prof_synonyms.txt', 'r').read())
...
predicate_file ="/home/tigunova/PycharmProjects/movie_experiment/raw_data/profession_list.txt"
...
def create_sample(predicate, inp_file):
    in_folder = "/home/tigunova/PycharmProjects/ham_rep/data/whitelists/train_" + predicate + "/"
    in_test = "/home/tigunova/PycharmProjects/ham_rep/data/whitelists/test_" + predicate + ".txt"


    train_folder = "/home/tigunova/PycharmProjects/ham_rep/data/train_" + predicate + "/"
    test_file = "/home/tigunova/PycharmProjects/ham_rep/data/test_" + predicate + ".txt"
        ...
        for line in f_in:
            ...
            if line[0] == curr_char:
                ...
                if curr_char != "" and curr_prof != -1 and curr_prof_name in category_whitelists:
                    ...
                    if res_file != None:
                        embed_user(inp_label=curr_prof, train_file=res_file, act_file=texts, batch_size=4,
                                                     character_id=char_count, in_words=False)
                        char_count += 1
                        has_ims = None
                curr_char = line[0]
                try:
...
create_sample(predicate = "profession", inp_file = "/home/tigunova/reddit_prof_restr_8/part-00000")